...
public class GeraCPF {
	...
	// primeiros digitos)
	public List<Integer> geraCPFParcial() {
		for (int i = 0; i < 9; i++) {
			int iAux = geraNumAleatorio();
			listaAleatoria.add(Integer.valueOf(iAux));
		}
	...
	public List<Integer> geraPrimeiroDigito() {
	...
	public List<Integer> geraSegundoDigito() {
		listaNumMultiplicados = new ArrayList<Integer>();
		int segundoDigito;
		int totalSomatoria = 0;
		int restoDivisao;
